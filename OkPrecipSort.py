...
'''
This set of code is intended for the formatting of the precipitation Oklahoma dataset (1950-2023)
...
df = pd.read_excel('Oklahoma Monthly Precipitation (1950-2023).xlsx')
...
df_sc = pd.DataFrame(single_column, columns=['OkPrecip'])
# #print(df_sc.head())
...
df_sc.to_csv('Oklahoma Monthly Precipitation (1950-2023).csv', index=False)
