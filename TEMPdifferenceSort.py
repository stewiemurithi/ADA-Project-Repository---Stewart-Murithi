...
'''
This set of code is intended for the formatting of the difference in temperature between Wichita, Kansas
...
df = pd.read_excel('Difference on Temperatures TEXKAN.xlsx')
...
df_sc = pd.DataFrame(single_column, columns=['TempDiff'])
# #print(df_sc.head())
...
df_sc.to_csv('Difference on Temperatures TEXKAN.csv', index=False)
