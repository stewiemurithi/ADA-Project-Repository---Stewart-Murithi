...
'''
This set of code is intended for the formatting of the difference in precipitation between Wichita, Kansas
and Dallas, Texas (1950-2023)
...
df = pd.read_excel('Difference on Precipitation TEXKAN.xlsx')
...
df_sc = pd.DataFrame(single_column, columns=['PrecipDiff'])
# #print(df_sc.head())
...
df_sc.to_csv('Difference on Precipitation TEXKAN.csv', index=False)
