...
# Importing the additional datasets with temperature values + precipitation values
...
# Ensuring 'Date' columns are treated as string
...
# Handling missing values in the 'PrecipDiff' column
df['PrecipDiff'] = df['PrecipDiff'].fillna(df['PrecipDiff'].mean())

# Ensuring correct column treatment
